...
export function getAISimulationEnabled() {
  return localStorage.getItem(DEV_AI_KEY) === "true";
}
export function setAISimulationEnabled(on) {
  localStorage.setItem(DEV_AI_KEY, String(on));
}
