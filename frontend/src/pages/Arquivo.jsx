    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100%", background: THEME.bg }}>
      ...
      <div style={{ padding: "20px 24px 0" }}>
        ...
        <div style={{ fontSize: 12, color: THEME.textDim, marginTop: 2 }}>
          Processos arquivados (mais de 3 anos) · {archived.length} registos
        </div>
      </div>
      ...
      <div style={{ padding: "12px 24px" }}>
        <div style={{ position: "relative", width: 240 }}>
          ...
          <input
            ...
            style={{ paddingLeft: 28, paddingRight: 10, paddingTop: 6, paddingBottom: 6, fontSize: 12, border: `1px solid ${THEME.border}`, borderRadius: 7, outline: "none", width: "100%", background: THEME.card, color: THEME.text }}
          />
        </div>
      </div>

      {/* Archive notice */}
      <div style={{ margin: "0 24px 12px", background: THEME.sidebar, border: `1px solid ${THEME.border}`, borderRadius: 8, padding: "8px 14px", display: "flex", alignItems: "center", gap: 8 }}>
